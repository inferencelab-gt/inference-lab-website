    ...
    <div className={
      ...
      <nav style={{
        ...
        <section id="os-career" style={{ marginBottom: 48 }}>
              ...
              prepare your job applications, and interviews. For postdocs, I will work closely since you start at the lab so that we have a clear plan for your career development.<br></br> <br></br> 

              I highly encourage at least one summer intenship during your PhD. My internship experience has changed the 
              career trajectory for me. So I value internship very highly for students. Going for internship every summer may harm your 
              research, so you need to think carefully and plan accordingly. You might want to build you research during the fist couple of years. <br></br> <br></br>
        ...
        <section id="os-ethics" style={{ marginBottom: 48 }}>
            ...
            Ethics at Inference Lab goes beyond compliance and it’s part of system design. Every model, dataset, and robot we build encodes assumptions that shape the real world. 
            <span style={{ color: '#FFD700', fontWeight: 700, background: dark ? '#FFD70022' : '#FFF8DC', padding: '4px 10px', borderRadius: 8, display: 'inline-block', boxShadow: dark ? '0 2px 8px #FFD70033' : '0 2px 8px #FFD70022', margin: '10px 0' }}>
                  Any breach of integrity, whether in code, data, writing, or results, will not be tolerated under any circumstances.</span>

            <div style={{ margin: '18px 0 18px 0' }}>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>

                <li style={{ marginBottom: 12 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>Integrity in Writing and AI Use:</span>
                  <span style={{ marginLeft: 8 }}>   

                    Use of AI writing tools (including chatbots) for generating text, 
                    figures, or code must comply with conference and journal rules. 
                    You are responsible for verifying every word and line as your own. 
                    Plagiarism, even in drafts, is unacceptable. Any sentence derived from 
                    prior work must be paraphrased properly or quoted with citation. Direct quotes 
                    require quotation marks and full references. Always secure permissions for reused 
                    figures, datasets, or extended excerpts.
                ...
                <li style={{ marginBottom: 12 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>Attribution and Acknowledgment:</span>
                  <span style={{ marginLeft: 8 }}>   

                    Give credit generously. Acknowledge collaborators, external tools, or 
                    libraries that influenced your work. Respect authorship ethics—every 
                    coauthor should have made a significant intellectual contribution.
                ...
                <li style={{ marginBottom: 12 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>Transparency and Accountability:</span>
                  <span style={{ marginLeft: 8 }}>   
                    
                    We document not only results but also decisions—why a dataset was used, 
                    why an algorithm was chosen, why a metric was prioritized. 
                    This documentation ensures that every piece of research from Inference 
                    Lab is reproducible, verifiable, and trustworthy.
        ...
        <section id="os-code" style={{ marginBottom: 48 }}>
            ...
            All code developed in the lab must be documented, version-controlled, and stored in the official Inference Lab GitHub organization. Every repository must include a clear README.md, environment setup (requirements.txt or environment.yml), usage examples, and contact information for the maintainer.

            Whenever possible, open-source releases should precede the camera-ready version of the corresponding paper to ensure transparency and reproducibility. Internal projects must maintain the same level of documentation, organization, and testing as public releases.

            All active code, datasets, and experimental results must exist in cloud storage with verified backups. Local-only code or results are not acceptable. Data loss due to lack of backup is considered a breach of lab policy.

            Standard Development Practices:

            Use branches for new features and submit pull requests for review before merging to main.

            Write modular, readable, and tested code; include inline comments for complex logic.

            Maintain CHANGELOGs and version tags for all major updates.

            Use issues and milestones to track bugs, features, and deliverables.

            Ensure reproducibility: all experiments must be runnable via scripts or notebooks with consistent random seeds.

            Follow consistent naming conventions for files, variables, and folders.

            Never store sensitive credentials, datasets, or third-party API keys in code repositories.
              </p>
              <div style={{ margin: '36px 0 0 0', borderBottom: `1.5px solid ${dark ? '#FFD700' : '#232733'}`, width: '100%', opacity: 0.12, borderRadius: 2 }} />
          </section>
          ...
          <section id="os-courses" style={{ marginBottom: 48 }}>
            <h2 style={{ fontSize: 22, fontWeight: 600, color: dark ? '#FFD700' : '#232733', margin: '0 0 14px 0', letterSpacing: 0.2 }}>
              What course should you take
            </h2>

            <p style={{ fontSize: 17, lineHeight: 1.7, marginBottom: 12, opacity: 0.85 }}>
              We learn like engineers. Everyone builds the same core foundation, then branches by research focus. 
              Core is mandatory. Tracks are selected with the advisor based on your project and gaps. This is a non-exhausitve list. 
            </p>

            {/* CORE — Mandatory for all Inference Lab students */}
            <div style={{ margin: '18px 0' }}>
              <div style={{ 
                ...
                borderRadius: 8,
                fontWeight: 700,
                color: dark ? '#232733' : '#232733',
                background: dark ? '#FFD700' : '#FFF8DC',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 8 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>MATH 6221</span>
                  <span style={{ marginLeft: 8 }}>Probability Theory for Scientists and Engineers</span>
                </li>
                <li style={{ marginBottom: 8 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>CS 6515</span>
                  <span style={{ marginLeft: 8 }}>Introduction to Graduate Algorithms</span>
                </li>
                <li style={{ marginBottom: 8 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>CS 7643</span>
                  <span style={{ marginLeft: 8 }}>Deep Learning</span>
                </li>
                <li style={{ marginBottom: 8 }}>
                  <span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6407</span>
                  <span style={{ marginLeft: 8 }}>Robotics</span>
                </li>
              </ul>
            </div>

            {/* TRACKS — Choose based on research focus */}
            <div style={{ margin: '18px 0 6px 0', fontWeight: 700, color: dark ? '#FFD700' : '#232733' }}>
              Recommended tracks (choose based on focus)
            </div>

            {/* AI / Learning Systems */}
            <div style={{ margin: '10px 0 18px 0' }}>
              <div style={{ fontWeight: 600, color: dark ? '#FFD700' : '#232733', marginBottom: 6 }}>AI and Learning Systems</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 7641</span><span style={{ marginLeft: 8 }}>Machine Learning</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 7642</span><span style={{ marginLeft: 8 }}>Reinforcement Learning and Decision Making</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 7644</span><span style={{ marginLeft: 8 }}>Machine Learning for Robotics</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 6476</span><span style={{ marginLeft: 8 }}>Introduction to Computer Vision</span></li>
                <li style={{ marginBottom: 0 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 6491</span><span style={{ marginLeft: 8 }}>Foundations of Computer Graphics</span></li>
              </ul>
            </div>

            {/* Design, CAD, and Simulation */}
            <div style={{ margin: '10px 0 18px 0' }}>
              <div style={{ fontWeight: 600, color: dark ? '#FFD700' : '#232733', marginBottom: 6 }}>Design, CAD, and Simulation</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6103</span><span style={{ marginLeft: 8 }}>Optimization in Engineering Design</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6104</span><span style={{ marginLeft: 8 }}>Computer-Aided Design</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6124</span><span style={{ marginLeft: 8 }}>Finite-Element Method: Theory and Practice</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6201</span><span style={{ marginLeft: 8 }}>Principles of Continuum Mechanics</span></li>
                <li style={{ marginBottom: 0 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 7227</span><span style={{ marginLeft: 8 }}>Additive Manufacturing and Rapid Prototyping</span></li>
              </ul>
            </div>

            {/* Robotics and Control */}
            <div style={{ margin: '10px 0 18px 0' }}>
              <div style={{ fontWeight: 600, color: dark ? '#FFD700' : '#232733', marginBottom: 6 }}>Robotics and Control</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6401</span><span style={{ marginLeft: 8 }}>Linear Control Systems</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6402</span><span style={{ marginLeft: 8 }}>Nonlinear Control Systems</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6403</span><span style={{ marginLeft: 8 }}>Digital Control Systems</span></li>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6405</span><span style={{ marginLeft: 8 }}>Introduction to Mechatronics</span></li>
                <li style={{ marginBottom: 0 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>ME 6408</span><span style={{ marginLeft: 8 }}>Advanced Mechatronics</span></li>
              </ul>
            </div>

            {/* Geometry, Programming Languages, and Modeling */}
            <div style={{ margin: '10px 0 18px 0' }}>
              <div style={{ fontWeight: 600, color: dark ? '#FFD700' : '#232733', marginBottom: 6 }}>Geometry, Languages, and Modeling</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 6764</span><span style={{ marginLeft: 8 }}>Geometric Modeling</span></li>
                <li style={{ marginBottom: 0 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CS 6390</span><span style={{ marginLeft: 8 }}>Programming Language Design</span></li>
              </ul>
            </div>

            {/* High-Performance Computing and Numerics */}
            <div style={{ margin: '10px 0 18px 0' }}>
              <div style={{ fontWeight: 600, color: dark ? '#FFD700' : '#232733', marginBottom: 6 }}>High-Performance Computing and Numerics</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 16 }}>
                <li style={{ marginBottom: 6 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CSE 6220</span><span style={{ marginLeft: 8 }}>High Performance Computing</span></li>
                <li style={{ marginBottom: 0 }}><span style={{ color: '#FFD700', fontWeight: 700 }}>CSE 6643</span><span style={{ marginLeft: 8 }}>Numerical Linear Algebra</span></li>
              </ul>
            </div>
